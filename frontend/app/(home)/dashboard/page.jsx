          ...
          <header className="flex flex-col sm:flex-row justify-between sm:items-center mb-10">
            ...
            {user?.role === 'professor' && (
              <Link
                ...
                className="mt-4 sm:mt-0 inline-flex items-center justify-center gap-2 bg-[#4f46e5] text-white font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300 transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
